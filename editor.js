...
entry_manager.build_entry = function (index) {
  var $a, $edit, property, this_field, $field, entry = watedit.LinkData.entries[index],
    $label = $('<div>', {
      'class': 'label'
    }),
    $entry = $('<li>', {
  ...
  for (field in fields) {
    if (Object.prototype.hasOwnProperty.call(fields, field)) {
      ...
      if (property !== undefined && property.text !== '') {
        $field = $('<div>', {
          'class': (this_field['class'] ? this_field['class'] + ' field' : 'field')
        });
        //take care of url
...
entry_manager.open_editor = function (index) {
  var this_field, property, field, $field, $input_label, $input,
  ...
  function build_input(purpose, multiline) {
    ...
    $input_label = $('<label>', {
      'for': 'input_' + field + purpose
    });
    $input_label.text(this_field.name + ' ' + purpose);
    if (multiline) {
      $input = $('<textarea>', {
        id: 'input_' + field + purpose,
        purpose: purpose,
...
field_manager.open_editor = function (index) {
  ...
  $properties.dialog({
    ...
    buttons: {
      Save: function () {
        var $inputs = $('input', $properties), n,
            $input, val, old_data, name, entry,
            old_name = field.name;
